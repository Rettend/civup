...
import { competitiveTierMeetsMaximum, competitiveTierMeetsMinimum, formatModeLabel, isTeamMode, maxPlayerCount, slotToTeamIndex, teamCount as modeTeamCount, teamSize as modeTeamSize } from '@civup/game'
