    ...
    render(() => (
      <DraftSetupPage lobby={createLobbySnapshot({
        ...
        tournament: {
          ...
          rosterLocked: true,
          entryRosters: [
            { entryId: 'entry-1', side: 0, members: [{ position: 0, slot: 0, playerId: 'host-1', displayName: 'Host Player', avatarUrl: null }] },
            { entryId: 'entry-2', side: 1, members: [{ position: 0, slot: 1, playerId: 'player-2', displayName: 'Player 2', avatarUrl: null }] },
          ],
        },
      })}
      />
