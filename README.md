...
This is a deployment guide, check out the [Manual](MANUAL.md) to see how the bot works on a high level, or the [Guide](GUIDE.md) for a quick start guide for players.
