...
const GAME_MODE_DEFINITIONS = {
  ...
  'ffa': { label: 'FFA', playerCountOptions: [12], teamSize: null, leaderboardMode: 'ffa', balanceLeaderboardMode: null, unranked: false, redDeathDuplicateFactionsRequired: false },
...
export function startPlayerCountOptions(
  ...
  if (mode === 'ffa' && targetSize === defaultPlayerCount(mode)) return FFA_START_PLAYER_COUNTS
