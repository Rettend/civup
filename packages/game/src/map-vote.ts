...
export const MAP_SCRIPTS: readonly MapScriptOption[] = [
  ...
  { id: 'pangaea', name: 'Pangaea', hint: 'Classic', imageUrl: '/assets/maps/Map_Pangaea.webp' },
  { id: 'terra', name: 'Terra' },
...
export const MAP_VOTE_MAPS: readonly MapVoteMapOption[] = [
  ...
  { id: 'pangaea', name: 'Pangaea', mapType: 'standard', mapScript: 'pangaea', badgeLeft: 'Classic', imageUrl: '/assets/maps/Map_Pangaea.webp' },
